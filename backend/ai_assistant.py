...
ВАЖЛИВО: Якщо питають про вік або дату народження членів родини — використовуй ТІЛЬКИ ці дані. Якщо даних про когось немає, чесно скажи, що не знаєш, і НЕ вигадуй.
