    ...
    <main className="h-screen w-full bg-slate-950 text-white p-2 flex flex-col gap-2 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col gap-2">
        ...
        <button 
          ...
          className={`flex-1 rounded-[30px] border-4 flex items-center justify-center gap-4 active:scale-95 ${isListening && activeMode === 'youtube' ? 'bg-green-600 border-green-400 animate-pulse' : 'bg-slate-800 border-slate-700'}`}
        >
